...
require 'neural/math/abstract_vector'
require 'neural/cuda'
require 'neural/cuda/vector'

module Neural
  module Ruby
    class Vector < Neural::Math::AbstractVector
      ...
      [ :abs, :exp,
        ...
        define_method(func) do
          begin
            ...
            self.class[Neural::Ruby::Vector[self.to_a].send(func)]
          end
        end
      end
  ...
  if ENV["NEURAL_USE_CUDA"] != "0" && Neural::CUDA.available?
    Vector = CUDA::Vector
  else
    Vector = Ruby::Vector
