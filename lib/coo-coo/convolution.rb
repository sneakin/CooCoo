  ...
  module Convolution
    class BoxLayer
      ...
      def initialize(width, height, horizontal_step, vertical_step, internal_layer, input_width, input_height, int_output_width, int_output_height, update_weights_with = :sum)
        ...
        raise ArgumentError.new("Weights delta accumulator can only be averaged or summed. Not #{delta_accumulator.inspect}") unless Sequence.instance_method(@delta_accumulator)
      end
