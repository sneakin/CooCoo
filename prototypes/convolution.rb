...
def generate_convolution(options, net, input_width, input_height)
...
def generate(option, training_set)
  ...
  options.convolutions.times do |convolution|
    input_width, input_height = generate_convolution(options, net, input_width, input_height)
  end
